...
const Hero = () => {
  return (
    <div
      ...
      className={`relative min-h-[70vh] md:min-h-screen md:bg-fixed bg-no-repeat bg-cover bg-center flex items-end`}
    >
      {/* dark overlay */}
      ...
      <div className="z-10 section-padding mb-8 sm:mb-12 md:mb-28">
        <div className="max-w-3xl">
          <h2 className="absolute top-24 left-1/2 -translate-x-1/2 sm:-translate-x-0 w-[80%] text-xl sm:max-w-full text-center sm:text-left sm:static sm:text-xl md:text-2xl font-bold mb-8">
